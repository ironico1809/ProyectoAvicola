...
export default function CrecimientoLote() {
  ...
  const handleCrear = async (e) => {
    ...
    if (!id_lote) {
      return setFormError("Selecciona un lote activo.");
    }
    ...
    setSaving(true);
    try {
      const res = await api.post("/lotes/control-calidad/", {
        id_lote,
        peso_registrado,
  ...
  const historialFiltrado = useMemo(() => {
    ...
    return historial.filter(
      (h) => String(h.id_lote) === String(filtroLote)
    );
    ...
    <div style={layoutStyle}>
      ...
      >
        <Topbar
          ...
          subtitulo="Registra la edad, peso y desvíos de tus lotes respecto a la curva de crecimiento estándar"
          sidebarOpen={sidebarOpen}
          setSidebarOpen={setSidebarOpen}
        />

        <div style={{ display: "flex", flexDirection: isNarrow ? "column" : "row", gap: "24px", marginTop: "24px" }}>
          
          {/* Card Formulario */}
          <div style={{ flex: isNarrow ? "none" : "0 0 400px", display: "flex", flexDirection: "column" }}>
            <div style={formCardStyle}>
              <h3 style={cardTitleStyle}>Nuevo Registro de Pesaje</h3>
              <p style={cardSubtitleStyle}>Ingresa los datos físicos de pesaje biológico de las aves.</p>
              
              <form onSubmit={handleCrear} style={{ display: "flex", flexDirection: "column", gap: "16px", marginTop: "16px" }}>
                <ComboBox
                  label="Lote Activo"
                  value={form.id_lote}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  ...
                  <div style={inputIconWrapperStyle}>
                    <FileText size={18} color="#9ca3af" style={{ alignSelf: "flex-start", marginTop: "12px" }} />
                    <textarea
                      name="observacion"
            ...
            <div style={containerStyle}>
              <div style={tableHeaderStyle}>
                <div>
                  ...
                  <p style={cardSubtitleStyle}>Registros históricos y desvíos calculados por el sistema.</p>
                </div>
